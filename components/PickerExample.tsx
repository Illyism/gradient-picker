...
export function GradientPicker({
  ...
  const images = [
    ...
    'url(https://images.unsplash.com/photo-1688822863443-578a749f1ceb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2532&q=90)',
